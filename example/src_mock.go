...
// gsmock -o src_mock.go -i '!RepositoryV2,,GenericService,Service,,Repository'
...
func (impl *ServiceMockImpl) MockM10() *mock.Mocker10[*exp.Request] {
	t := reflect.TypeFor[ServiceMockImpl]()
	return mock.NewMocker10[*exp.Request](impl.r, t, "M10")
}
...
func (impl *ServiceMockImpl) MockM11() *mock.Mocker11[*exp.Request, *Response] {
	t := reflect.TypeFor[ServiceMockImpl]()
	return mock.NewMocker11[*exp.Request, *Response](impl.r, t, "M11")
}
...
func (impl *ServiceMockImpl) MockM12() *mock.Mocker12[*exp.Request, *Response, bool] {
	t := reflect.TypeFor[ServiceMockImpl]()
	return mock.NewMocker12[*exp.Request, *Response, bool](impl.r, t, "M12")
}
...
func (impl *ServiceMockImpl) MockM22() *mock.Mocker22[context.Context, map[string]*exp.Request, *Response, bool] {
	t := reflect.TypeFor[ServiceMockImpl]()
	return mock.NewMocker22[context.Context, map[string]*exp.Request, *Response, bool](impl.r, t, "M22")
}
