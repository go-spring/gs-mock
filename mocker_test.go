...
func (c *Client) GetWithHeader(ctx context.Context, req *Request, trace *Trace) (*Response, map[string]string, error) {
	if ret, ok := mock.InvokeContext(ctx, clientType, "GetWithHeader", ctx, req, trace); ok {
		return mock.Unbox3[*Response, map[string]string, error](ret)
	}
	return &Response{Message: "9:yyy"}, nil, nil
}

// MockGetWithHeader registers a mock implementation for the GetWithHeader method.
func MockGetWithHeader(r *mock.Manager) *mock.Mocker33[context.Context, *Request, *Trace, *Response, map[string]string, error] {
	return mock.NewMocker33[context.Context, *Request, *Trace, *Response, map[string]string, error](r, clientType, "GetWithHeader")
}
...
func (c *MockClient) QueryWithHeader(req *Request, trace *Trace) (*Response, map[string]string, error) {
	if ret, ok := mock.Invoke(c.r, mockClientType, "QueryWithHeader", req, trace); ok {
		return mock.Unbox3[*Response, map[string]string, error](ret)
	}
	panic("mock error")
}
...
func (c *MockClient) MockQueryWithHeader() *mock.Mocker23[*Request, *Trace, *Response, map[string]string, error] {
	return mock.NewMocker23[*Request, *Trace, *Response, map[string]string, error](c.r, mockClientType, "QueryWithHeader")
}
