...
func New{{.Name}}MockImpl[{{.TypeParams}}](r *mock.Manager) *{{.Name}}MockImpl[{{.TypeParamNames}}] {
...
func (impl *{{.i.Name}}MockImpl[{{.i.TypeParamNames}}]) {{.m.Name}}(){
	...
	if _, ok := mock.Invoke(impl.r, t, "{{.m.Name}}"); ok {
		return
	}
	panic("no mock code matched")
}

func (impl *{{.i.Name}}MockImpl[{{.i.TypeParamNames}}]) Mock{{.m.Name}}() *mock.Mocker00 {
	t := reflect.TypeFor[{{.i.Name}}MockImpl[{{.i.TypeParamNames}}]]()
	return mock.NewMocker00(impl.r, t, "{{.m.Name}}")
}
{{- else}}
...
func (impl *{{.i.Name}}MockImpl) Mock{{.m.Name}}() *mock.Mocker00 {
	t := reflect.TypeFor[{{.i.Name}}MockImpl]()
	return mock.NewMocker00(impl.r, t, "{{.m.Name}}")
}
{{- end}}
...
func (impl *{{.i.Name}}MockImpl[{{.i.TypeParamNames}}]) {{.m.Name}}()({{.m.ResultTypes}}){
	t := reflect.TypeFor[{{.i.Name}}MockImpl[{{.i.TypeParamNames}}]]()
	if ret, ok := mock.Invoke(impl.r, t, "{{.m.Name}}"); ok {
		return mock.Unbox{{.m.ResultCount}}[{{.m.ResultTypes}}](ret)
	}
	panic("no mock code matched")
}

func (impl *{{.i.Name}}MockImpl[{{.i.TypeParamNames}}]) Mock{{.m.Name}}() *mock.Mocker0{{.m.ResultCount}}[{{.m.ResultTypes}}] {
	t := reflect.TypeFor[{{.i.Name}}MockImpl[{{.i.TypeParamNames}}]]()
	return mock.NewMocker0{{.m.ResultCount}}[{{.m.ResultTypes}}](impl.r, t, "{{.m.Name}}")
}
{{- else}}
...
func (impl *{{.i.Name}}MockImpl) Mock{{.m.Name}}() *mock.Mocker0{{.m.ResultCount}}[{{.m.ResultTypes}}] {
	t := reflect.TypeFor[{{.i.Name}}MockImpl]()
	return mock.NewMocker0{{.m.ResultCount}}[{{.m.ResultTypes}}](impl.r, t, "{{.m.Name}}")
}
{{- end}}
...
func (impl *{{.i.Name}}MockImpl[{{.i.TypeParamNames}}]) {{.m.Name}}({{.m.Params}}){
	t := reflect.TypeFor[{{.i.Name}}MockImpl[{{.i.TypeParamNames}}]]()
	if _, ok := mock.Invoke(impl.r, t, "{{.m.Name}}", {{.m.ParamNames}}); ok {
		return
	}
	panic("no mock code matched")
}

func (impl *{{.i.Name}}MockImpl[{{.i.TypeParamNames}}]) Mock{{.m.Name}}() *mock.Mocker{{.m.ParamCount}}0[{{.m.ParamTypes}}] {
	t := reflect.TypeFor[{{.i.Name}}MockImpl[{{.i.TypeParamNames}}]]()
	return mock.NewMocker{{.m.ParamCount}}0[{{.m.ParamTypes}}](impl.r, t, "{{.m.Name}}")
}
{{- else}}
...
func (impl *{{.i.Name}}MockImpl) Mock{{.m.Name}}() *mock.Mocker{{.m.ParamCount}}0[{{.m.ParamTypes}}] {
	t := reflect.TypeFor[{{.i.Name}}MockImpl]()
	return mock.NewMocker{{.m.ParamCount}}0[{{.m.ParamTypes}}](impl.r, t, "{{.m.Name}}")
}
{{- end}}
