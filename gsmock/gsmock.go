...
// tmplFile is the template used to generate the mock code.
var tmplFile = template.Must(template.New("").Parse(`
...
func run(param runParam) {
	...
	// Generate the mock code using template.
	s := bytes.NewBuffer(nil)
	err := tmplFile.Execute(s, map[string]any{
